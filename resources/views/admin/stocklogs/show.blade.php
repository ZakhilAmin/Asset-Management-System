...
@section('btn')
<a class="btn btn-primary top-right-align" href="{{ route('stocklogs.index') }}">
...
@section('content')
      ...
      <div class="panel panel-primary uper">
        ...
        <h4>View <strong>ID#{{$stock->id}}</strong> Details</h4>
        </div>
        <div class="panel-body">
          <div class="col-lg-12 col-md-12 col-xs-12 pull-left">
              ...
              <h3>Tag No: {{$stock->tag_no}}</h3>
            <h3>Operation: {{$stock->operation}}</h3>
